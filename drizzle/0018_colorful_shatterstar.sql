...
CREATE TABLE `subscription_payments` (
	...
	`payment_provider_subscription_id` varchar(100),
...
--> statement-breakpoint
ALTER TABLE `credits` ADD `is_deleted` boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE `credits` ADD `deleted_at` timestamp;--> statement-breakpoint
ALTER TABLE `debtors` ADD `is_deleted` boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE `debtors` ADD `deleted_at` timestamp;--> statement-breakpoint
ALTER TABLE `expenses` ADD `is_deleted` boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE `expenses` ADD `deleted_at` timestamp;--> statement-breakpoint
ALTER TABLE `invoices` ADD `is_deleted` boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE `invoices` ADD `deleted_at` timestamp;--> statement-breakpoint
ALTER TABLE `sales` ADD `is_deleted` boolean DEFAULT false NOT NULL;--> statement-breakpoint
...
CREATE INDEX `user_subscription_status__idx` ON `user_subscriptions` (`status`);--> statement-breakpoint
